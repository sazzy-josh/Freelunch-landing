...
const HeroSection = () => {
  return (
    <div className='relative flex h-[90vh] w-full flex-col items-center overflow-hidden mb-8 md:h-[1016px]'>
      <div
      ...
      />
      <div className='relative text-[#04764E] text-3xl md:text-6xl font-extrabold track-[80px] mt-12 text-center z-10'>
      ...
      <Image src={Arrow} alt='card' className='arrow-img' />

      <div className='w-full lg:-mt-20  max-w-5xl z-10 mt-20 md:mt-0'>
